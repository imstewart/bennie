...
var typed = new Typed('.bgVideo  span.type', {
  strings : [ " " , "<i class='fa fa-users'></i> The Knowledge of Bathgate",
             " <i class='fa fa-product-hunt'></i> Searching the background of West Lothian",
             " <i class='fa fa-building'></i> Finding our History"],
    loop:true,
    typeSpeed: 40,
    backSpeed:30
});
